...
class FetchJeepTest extends FetchJeepTestSupport {
  ...
  @Test
  void testThatAnErroMessageIsReturnedWhenAnUnknownTrimIsSupplied() {
  ...
  void testThatAnErroMessageIsReturnedWhenAnInvalidValueIsSupplied(
 ...
 static Stream<Arguments> parametersForInvalidInput() {
   // @formatter:off
   return Stream.of(
       arguments("WRANGLER", "@#$%$", "Trim contains non-alpha-numberic characters."),
